...
namespace brumski_py::school{
    ...
    char course_grade(const std::string& name){    
        ...
        while(true){           
            if(score < 0 || score > 100){
                ...
                score = brumski_py::math::gradeinput<float>("Enter your "+name+" score: ");
             }
             else{
        ...
        char grade = brumski_py::math::grade::calculator(score);    
    ...
    int course_grade_point(const char& grade, const int& course_units){
        ...
        return brumski_py::math::grade::point(grade, course_units);
    }
